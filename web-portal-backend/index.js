...
//     //     Type_relationship :Type_relationship  ,
//     //     emergency_contact_number :emergency_contact_number  ,
//     //     disability:disability},{new:true},(error,updatedRecord)=>{
...
//         bank_name :bank_name ,
//         bank_account_no :bank_account_no ,
//         ifsc_code:ifsc_code },{new:true}, (err,updatedDocuments)=>{
...
//     Education.findOneAndUpdate({employee_code:req.body.employee_code},{ employee_code : employee_code,
...
//         intermediate_school_name:intermediate_school_name,
//         intermediate_school_place:intermediate_school_place ,
//         intermediate_percentage_cgpa: intermediate_percentage_cgpa},{new:true},(err,updatedEducation)=>{
//             Education.find({employee_code:req.body.employee_code},(err,educationuser)=>{
...
//     const {employee_code,last_company_name1,designation1,doj1,dol1, last_company_name2, designation2,doj2,dol2, last_company_name3,designation3,doj3,dol3,last_company_name4,designation4, doj4,dol4,last_company_name5,designation5,doj5,dol5} = req.body
...
//         designation5:designation5,
//         doj5:doj5,
//         dol5:dol5},{new:true},(err,updatedPrevious)=>{
...
//         how_do_you_know_about_this_job:req.body.how_do_you_know_about_this_job},{new:true},(err,updatedOffice)=>{
...
const personalInfoSchema = mongoose.Schema({
    ...
    Type_relationship:String,
    emergency_contact_number:String,
    emergency_contact_person2:String,
    relationship2:String,
    Type_relationship2:String,
...
const Document = new mongoose.model("Document", documentsInfoSchema)

const Education = new mongoose.model("Education",educationInfoSchema)

const PreviousDetails = new mongoose.model("PreviousDetails",previousInfoSchema)

const OfficeDetail = new mongoose.model("OfficeDetail",officeInfoSchema)
...
app.post("/personaldetails", (req,res)=> {
    ...
    const {employee_code, employement_type,full_name,gender,marital_status,fathers_name,mothers_name,contact_number, dob,blood_group,personal_email_id, permanent_address, state_permanent, district_permanent,pincode_permanent,current_address,state_current,
        district_current,
        pincode_current,
        skype_id  ,
        linked_handle,
    ...
    const personalInfo= new PersonalDetails ({
        ...
        relationship :relationship,
        Type_relationship :Type_relationship,
        emergency_contact_person2:emergency_contact_person2,
        relationship2:relationship2,
        Type_relationship2:Type_relationship2,
        emergency_contact_number2:emergency_contact_number2,
        disability :disability,
        last_updated:ts1
    ...
    console.log(personalInfo)
    // // PersonalDetails.findOneAndUpdate({employee_code:req.body.employee_code},{ employee_code : employee_code,employement_type:employement_type,full_name : full_name  ,
    // //     gender :gender,marital_status : marital_status,fathers_name : fathers_name,mothers_name : mothers_name, contact_number : contact_number,personal_email_id: personal_email_id,
    // //     dob :dob,blood_group : blood_group,permanent_address : permanent_address, state_permanent:state_permanent,district_permanent:district_permanent,pincode_permanent:pincode_permanent, current_address :current_address,state_current:state_current,
    // //     district_current:district_current,
    // //     pincode_current:pincode_current,skype_id :skype_id ,
    ...
    // //     relationship :relationship ,
    // //     Type_relationship :Type_relationship  ,
    // //     emergency_contact_number :emergency_contact_number  , emergency_contact_person2:emergency_contact_person2,
    // //     relationship2:relationship2,
    // //     Type_relationship2:Type_relationship2,
    // //     emergency_contact_number2:emergency_contact_number2,
...
app.post("/documentation", (req,res)=> {
    ...
    const {employee_code,aadhar_no,upload_aadhar, pan_no,upload_pan , passport_no, passport_issue_place,passport_issue_date,passport_expiry_date, bank_name, bank_account_no, ifsc_code,branch } = req.body

    const documentsInfoe= new Document ({
        employee_code : employee_code,
    ...
    documentsInfoe.save(function(err, result) {
        if (err){
            res.send(err)
        }
        else{
    ...
    // Document.findOneAndUpdate({employee_code:req.body.employee_code},{employee_code : employee_code,
    ...
    //     bank_name :bank_name ,
    //     bank_account_no :bank_account_no ,
    //     ifsc_code:ifsc_code,branch:branch,last_updated:ts2},{new:true}, (err,updatedDocuments)=>{
    //         Document.find({employee_code:req.body.employee_code},(err,documentsuser)=>{
    //             documentsuser[0].remove();
    //         // console.log(updatedDocuments);
    //         })
    // })
...
app.post("/previousemployment", (req,res)=> {
    ...
    PreviousDetails.findOneAndUpdate({
        no_of_row:no_of_row,
        employee_code : employee_code,
        last_company_name1:last_company_name1,
        designation1:designation1,
...
app.post("/officedetails", (req,res)=> {
    ...
    const officeInfo= new OfficeDetail ({
        employee_code : employee_code,
        designation:designation,
        doj:doj,
        office_location:office_location,
    ...
    OfficeDetail.findOneAndUpdate({employee_code:req.body.employee_code},{employee_code:req.body.employee_code,
        ...
        how_do_you_know_about_this_job:req.body.how_do_you_know_about_this_job,last_updated:ts5},{new:true},(err,updatedOffice)=>{
            OfficeDetail.find({employee_code:req.body.employee_code},(err,officeuser)=>{
                officeuser[0].remove();
...
app.post("/details",(req,res)=>{
    ...
    Document.find({employee_code:req.body.employee_code},(err,documentuser)=>{
